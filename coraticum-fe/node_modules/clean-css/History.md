...
* Fixed tests, [package.json](/coraticum-fe/package.json) for development, and regex
...
* Updated repository location and author information in [package.json](/coraticum-fe/package.json).
